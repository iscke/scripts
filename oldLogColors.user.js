...
// @name         log colours
// @version      0.1
// @description  ps name colours in logs
// @match        *://logs2.psim.us:8080/*/*.html*
// @match        *://logs.psim.us:8080/*/*.html*
// @grant        none
// ==/UserScript==

(function() {
    'use strict';
    for (var e of document.getElementsByClassName('username')) {
        e.setAttribute('style', hashColor(toID(e.innerText)));
    }

    // color code from smogon/pokemon-showdown-client
    // MD5 minified
